...
python run_experiment.py -a 2 -b 0.2 -t 0.1 -s s -p 0.05 -u True -n 5 -l 1 -D 550 
mkdir ../Logs/Smart1.2.2/
cp /tmp/* ../Logs/Smart1.2.2/
sleep 2

python run_experiment.py -a 2 -b 0.2 -t 0.1 -s s -p 0.05 -u True -n 5 -l 2 -D 550 
mkdir ../Logs/Smart2.2.2/
cp /tmp/* ../Logs/Smart2.2.2/
sleep 2

python run_experiment.py -a 2 -b 0.2 -t 0.1 -s s -p 0.05 -u True -n 5 -l 3 -D 1100 
mkdir ../Logs/Smart3.2.2/
cp /tmp/* ../Logs/Smart3.2.2/
sleep 2
